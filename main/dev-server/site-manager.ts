...
export interface DevWorkspace {
    ...
    label?: string;
    /**
     * This workspace hosts an installed Genie App (`app`), is one being
     * developed (`app-dev`), or is the throwaway workspace behind a PREVIEW
     * window (`app-preview`). Absent on an ordinary workspace (Tynn #250).
     *
