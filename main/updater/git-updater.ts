...
// Semver comparison moved to the Electron-free ./semver module (so the remote
// link-state machine can share it). Re-exported here for existing importers
// (auto-updater.ts, update-surface.ts, the semver test); also imported above for
// the internal isNewer() use.
export { isNewer };
